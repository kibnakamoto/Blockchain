...
class BlockHeader:
    ...
    def add_block(self):
        ...
        with open(f"user/{self.block_index}/block.json", 'w'):
            pass

        # append all transactions included in Merkle Tree in transactions.json
        with open(f"user/{self.block_index}/transactions.json", 'w'):
            pass
